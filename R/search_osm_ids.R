#' Search OSM IDs
#' 
#' Using a polygon, census tract, census blockgroup, zip code, or point, search StreetLight's OSM database.
#'
#' @param polygon GeoJSON feature collection __or__ sf object of type 
