...
StreetLight offers a limited-feature API, which allows users to upload zone sets, create analyses, check project status, and download results. Contact StreetLight support to request an API key and quick start guide.

### API key management  

Contact StreetLight Data support to request an API key. Use `streetlight_api_key()` to save the key for future use. 
```{r}
...
Please review the [CONTRIBUTING](.github/CONTRIBUTING.md) guide before making a contribution.
